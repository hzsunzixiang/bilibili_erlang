...
\textcolor{erlinit}{\textbf{init/1}}\\
    ...
    \node[font=\scriptsize\ttfamily, text width=5.4cm, align=left, anchor=north west] at ([xshift=6pt, yshift=-18pt]lb.north west) {
        gen\_server:call(\textcolor{erlname}{\textbf{ServerName}}, Req)\\
        gen\_server:cast(\textcolor{erlname}{\textbf{ServerName}}, Msg)\\
        gen\_server:send\_request(\textcolor{erlname}{\textbf{ServerName}}, Req)\\
        gen\_server:stop(\textcolor{erlname}{\textbf{ServerName}})
    };
    % Note: ServerName = {local, counter_server} or counter_server
    \node[font=\tiny\color{gray}, anchor=south west] at ([xshift=6pt, yshift=3pt]lb.south west)
        {备注：\textcolor{erlname}{\textbf{ServerName}} = \texttt{\{local, counter\_server\}} 或 \texttt{counter\_server}};
