...
\textcolor{erlinit}{\textbf{init/1}}\\
    ...
    \node[font=\scriptsize, text width=5.0cm, align=left, anchor=north west] at ([xshift=6pt, yshift=-16pt]rt.north west) {
        ...
        {\tiny\texttt{start\_link} $\rightarrow$ \texttt{proc\_lib:start\_link} $\rightarrow$ \texttt{init\_it} $\rightarrow$ \textcolor{erlinit}{\textbf{\texttt{Mod:init/1}}}}\\[3pt]
...
{\tiny\textcolor{erlred!80!black}{\textbf{存储\kern1pt\textcolor{erlmodule}{\texttt{?MODULE}}\kern1pt 信息 $\rightarrow$ 缓存函数引用}}}\\
    ...
    \node[draw=erlgreen!70!black, fill=erlgreen!5, rounded corners=5pt,
          minimum width=5.8cm, minimum height=3.4cm, text width=5.4cm, align=left] (rb) at (6.4, -2.5) {};
