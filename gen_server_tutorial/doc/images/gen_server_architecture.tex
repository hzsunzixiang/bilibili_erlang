...
\begin{tikzpicture}[scale=0.68, every node/.style={scale=0.68},
    ...
    \node[font=\tiny\ttfamily\color{erlpurple!60}, anchor=north east] at ([xshift=-3pt, yshift=-3pt]lt.north east) {counter\_server.erl};
    ...
    \node[font=\tiny\ttfamily\color{erlgreen!60}, anchor=north east] at ([xshift=-3pt, yshift=-3pt]lb.north east) {counter\_server.erl};
    ...
    \node[font=\tiny\ttfamily\color{erlblue!60}, anchor=north east] at ([xshift=-3pt, yshift=-3pt]rt.north east) {gen\_server.erl};
