...
\begin{frame}[fragile]{compile 输出解析：依赖下载之后生成 application 描述文件}
  \begin{block}{rebar3 compile 终端输出}
\begin{lstlisting}[
...
[ericksun@ERICKSUN-MC1:full_otp_app] (*@\textcolor{warning}{(main)}@*) (*@\textcolor{accent}{\$}@*) rebar3 compile
...
../../../../../../opt/homebrew/Cellar/erlang@26/26.2.5.16/...
...
\end{lstlisting}
  ...
  \vspace{0.12cm}
  \footnotesize
  \good{这一页只看输出本身：rebar3 先下载依赖，再分析 application，最后编译当前工程；下一页再打开生成出来的 \code{full\_otp\_app.app.src}。}
\end{frame}
