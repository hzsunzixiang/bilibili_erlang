  ...
  \begin{block}{runtime application 的启动链路}
    ...
    \begin{tikzpicture}[
      ...
      box/.style={
        ...
        minimum width=2.1cm, minimum height=1.5cm, align=center,
        font=\footnotesize\bfseries
      },
      arrow/.style={->, >=Stealth, line width=1.2pt, color=accent}
    ]
    \node[box] (n1) {\keypoint{工程结构}\\[2pt] {\ttfamily\footnotesize\color{muted} src/}};
    \node[box, right=of n1] (n2) {\keypoint{工具配置}\\[2pt] {\ttfamily\footnotesize\color{muted} rebar.config}};
    \node[box, right=of n2] (n3) {\keypoint{.app.src}\\[2pt] {\ttfamily\footnotesize\color{muted} mod}};
    \node[box, right=of n3] (n4) {\keypoint{callback}\\[2pt] {\ttfamily\footnotesize\color{muted} start/2}};
    \node[box, right=of n4] (n5) {\keypoint{top supervisor}\\[2pt] {\ttfamily\footnotesize\color{muted} full\_otp\_app\_sup}};
    \node[box, right=of n5] (n6) {\keypoint{Observer}\\[2pt] {\ttfamily\footnotesize\color{muted} supervision tree}};

    \draw[arrow] (n1.east) -- (n2.west);
    \draw[arrow] (n2.east) -- (n3.west);
    \draw[arrow] (n3.east) -- (n4.west);
    \draw[arrow] (n4.east) -- (n5.west);
    \draw[arrow] (n5.east) -- (n6.west);
    \end{tikzpicture}
  \end{block}
