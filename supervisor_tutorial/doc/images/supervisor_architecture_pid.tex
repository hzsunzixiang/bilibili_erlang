...
\textcolor{erlinit}{\textbf{init/1}}\\[2pt]
    ...
    \node[font=\scriptsize, text width=5.4cm, align=left, anchor=north west] at ([xshift=6pt, yshift=-16pt]rb.north west) {
        ...
        \texttt{ChildSpec = \#\{id, start, restart, ...\ \}}\\
        \texttt{child\_1: \{M, F, A\}} $\rightarrow$ \texttt{Pid\_1}\\
        \texttt{child\_2: \{M, F, A\}} $\rightarrow$ \texttt{Pid\_2}\\
        \texttt{child\_N: \{M, F, A\}} $\rightarrow$ \texttt{Pid\_N}\\[0pt]
        {\tiny\textcolor{gray}{每个子进程由 ChildSpec 中的 \texttt{\{M, F, A\}} 启动}}
    };
